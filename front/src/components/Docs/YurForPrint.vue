<template>
  <v-row>
    <v-col cols="12" class="pt-12">
      <section ref="yurik-contract-for-buy">
        ...
        <div class="text-justify">
          ...
          {{ yurik.field1 }} , именуемый в дальнейшем «Покупатель», в лице
          {{ yurik.field2 }} , действующего на основании {{ yurik.field3 }}
    ...
    <v-col cols="12" class="pt-12">
      <section ref="yurik-contract-for-nanesenie">
        ...
        <div class="text-justify">
          ...
          {{ yurik.field1 }} , именуемое в дальнейшем «Заказчик», в лице
          {{ yurik.field2 }} , действующего на основании {{ yurik.field3 }}
          с другой стороны, совместно именуемые Стороны, заключили настоящий
          Договор о нижеследующем:
        </div>
